...
<div class="edit-layout">
  ...
  <aside class="recipe-sidebar">
    <div class="sidebar-header">
      ...
      <a href="/inference/recipe" class="sidebar-back">All</a>
    </div>
    <ul class="sidebar-list">
      {#each data.recipes as r (r.id)}
        <li>
          <a
            href="/inference/recipe/{r.slug}/edit"
            class="sidebar-item"
  ...
  <div class="save-bar" id="save-bar">
    ...
    <div class="save-actions">
      ...
      {/if}
      <a href="/inference/recipe" class="btn-ghost">Cancel</a>
      <button
        class="btn-save"
