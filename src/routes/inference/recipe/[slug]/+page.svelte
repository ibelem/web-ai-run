...
<div class="recipe-detail">
  <header class="page-header">
    ...
    <div class="header-actions">
      ...
      <a href="/inference/recipe/new?fork={recipe.slug}" class="btn-fork">Fork</a>
      {#if data.isOwner}
        <a href="/inference/recipe/{recipe.slug}/edit" class="btn-edit">Edit</a>
  ...
  <div class="back-link">
    <a href="/inference/recipe">&larr; All Recipes</a>
  </div>
</div>
