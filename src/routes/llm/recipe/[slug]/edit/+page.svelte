<script lang="ts">
  ...
  async function save() {
    ...
    if (result?.data?.deleted) { goto('/llm/recipe'); return; }
    goto(`/llm/recipe/${data.recipe.slug}`);
  }
</script>
...
<aside class="recipe-sidebar">
  ...
  <ul class="sidebar-list">
    <li>
      <a href="/llm/recipe/new" class="sidebar-item new-item">New Recipe</a>
    </li>
    {#each (data.recipes ?? []) as r (r.id)}
      <li>
        <a href="/llm/recipe/{r.slug}/edit" class="sidebar-item" class:active={r.slug === data.recipe.slug}>
...
<div class="edit-page">
  <header class="page-header">
    ...
    <a href="/llm/recipe/{data.recipe.slug}" class="btn-back">← Back</a>
  </header>
  ...
  <div class="save-bar">
    ...
    <div class="save-actions">
      ...
      {/if}
      <a href="/llm/recipe/{data.recipe.slug}" class="btn-ghost">Cancel</a>
