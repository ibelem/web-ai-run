...
<div class="recipe-page">
  <header class="page-header">
    ...
    <div class="page-header-actions">
      <a href="/llm/recipe/import" class="btn-import-recipe">Import</a>
      <a href="/llm/recipe/new" class="btn-new-recipe">New Recipe</a>
    </div>
  </header>
...
{#snippet recipeCard(recipe: any, showOwner: boolean, showOwnerActions: boolean)}
  <div class="recipe-card">
    <div class="card-top">
      <a href="/llm/recipe/{recipe.slug}" class="card-name" title={recipe.name}>
    ...
    <div class="card-actions">
      ...
      {#if showOwnerActions && data.userId === recipe.owner_id}
        ...
        <a href="/llm/recipe/{recipe.slug}/edit" class="action-btn action-edit">Edit</a>
