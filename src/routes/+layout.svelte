  ...
  <div class="nav-left">
    ...
    <a href="/" class="logo">
      <svg class="logo-icon" height="32" viewBox="0 0 642 160" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle class="logo_cicle" cx="15" cy="82" r="12" fill="white" stroke="#C61A3E" stroke-width="6"/>
        <circle class="logo_cicle"  cx="75" cy="39" r="12" fill="white" stroke="#C61A3E" stroke-width="6"/>
        <circle class="logo_cicle" cx="163" cy="52" r="12" fill="white" stroke="#C61A3E" stroke-width="6"/>
        <circle class="logo_cicle" cx="101" cy="104" r="12" fill="white" stroke="#C61A3E" stroke-width="6"/>
        <circle class="logo_cicle" cx="156" cy="145" r="12" fill="white" stroke="#C61A3E" stroke-width="6"/>
