...
<a
  ...
  title="View in Netron"
  aria-label="View {filePath} in Netron"
...
<style>
  ...
  :global([data-theme="dark"]) .netron-link .logo-stroke,
  :global([data-theme="dark"]) .netron-link .logo-border {
    stroke: #ffffff;
  }

  :global([data-theme="dark"]) .netron-link .logo-fill {
    fill: #ffffff;
  }
</style>
